...
def get_word(list_of_word):
    return str(random.choice(list_of_word)).upper()
...
def play(word):
    ...
    while guessed == False:
        ...
        if len(guessed_letters) != 0:
            print('Вы уже назвали буквы:\n', *guessed_letters)
        if len(guessed_words) != 0:
            print('Вы уже назвали слова:\n', *guessed_words)
        c = input('Введите букву из слова или слово целиком:\n')
        c = c.upper()
        ...
        if c.isalpha():
            ...
            if len(c) == 1:
                ...
                if c in word:
                    print('Верно! Эта буква есть в загаданном слове!')
                    for j in range(len(word)):
                        if word[j] == c:
                            word_completion[j] = c
                            continue
                else:
                    print('Такой буквы в загаданном слове нет =(')
                    tries -= 1
                    print(display_hangman(tries))
        else:
            print('К вводу принимаются только буквы!')
            continue
...
while True:
    ...
    play(word)
    ans = input('Хотите сыграть еще раз? д = ДА н = НЕТ')
